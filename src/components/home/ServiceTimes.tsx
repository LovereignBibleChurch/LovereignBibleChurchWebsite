            ...
            <span className="bg-gradient-to-r from-gray-100 via-gray-300 to-gray-100 bg-clip-text text-transparent">
              Join Us for{" "}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    ...
                    <span className="bg-gradient-to-r from-gray-600 to-gray-700 text-gray-100 px-4 py-1 rounded-full text-xs font-medium shadow-lg">
                      Most Popular
                    </span>
                                    </div>
                                )}
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="flex items-start mb-4">
                                        ...
                                        <div>
                                            <p className="font-semibold text-gray-100 text-lg">{service.time}</p>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-gray-400 font-medium">{service.location}</p>
                                    </div>
